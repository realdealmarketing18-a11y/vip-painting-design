        ...
        <motion.div {...fade(0.15)} style={s.videoCol}>
          ...
          <div style={s.founderStrip}>
            ...
            <p style={s.founderText}>
              “I’ll show you exactly why our process and materials make all the
              difference.”
...
const s = {
  ...
  videoOverlay: {
    position: 'absolute',
    inset: 0,
    background: `linear-gradient(to top, ${NAVY}CC 0%, transparent 55%)`,
  },
  playBtn: {
    position: 'absolute',
    inset: 0,
  ...
  playCircle: {
    ...
    justifyContent: 'center',
    paddingLeft: '3px',
    boxShadow: '0 4px 18px rgba(196,151,60,0.5)',
  },
  founderStrip: {
    background: NAVY,
    padding: '14px 18px',
  ...
  badgeRing: {
    ...
    height: '130px',
    borderRadius: '50%',
    background: `conic-gradient(${GOLD} 0deg, #E8C870 180deg, ${GOLD} 360deg)`,
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    boxShadow: `0 6px 24px rgba(196,151,60,0.4)`,
  },
  badgeInner: {
    width: '108px',
    height: '108px',
