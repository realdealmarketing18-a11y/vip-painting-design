      ...
      <div className="container" style={s.inner}>
        ...
        <div style={s.logoCol}>
          <div style={s.logoWrap}>
            ...
            <div>
              <div style={s.vip}>VIP</div>
              <div style={s.hp}>HOME PAINTING</div>
            </div>
          </div>
        </div>
        ...
        <div style={s.rightCol}>
          <p style={s.tagline}>
            We don’t just paint homes,<br /><em>we transform lives.</em>
          </p>
          <div style={s.socials}>
            {['f', 'in', 'G', '▶'].map((ic) => (
              <div key={ic} style={s.socialIcon}>
                <span style={s.socialIc}>{ic}</span>
              </div>
            ))}
          </div>
        </div>
